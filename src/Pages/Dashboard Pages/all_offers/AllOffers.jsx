...
import AddOffersForm from "./AddOffers";
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          Swal.fire("خطأ!", "حدث خطأ أثناء محاولة حذف العرض.", "error");
        }
      }
    });
  };
      ...
      <div className="page-body-wrapper">
        ...
        <div className="add_user_container">
          <div style={{ marginTop: "30px" }}>
            <PageHeader name="كل العروض" icon="fa fa-tag" />
          </div>
            ...
            <div className="popup-overlay">
              <div className="popup-content">
                ...
                <h4 className="card-title mb-4">
                  {editingOffer ? "تعديل العرض" : "نموذج إضافة عرض جديد"}
                </h4>
                <AddOffersForm
